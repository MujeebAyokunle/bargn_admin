...
import { AcceptAdminInviteApi, FetchAdminApi, getCoordinateApi } from '@/apis';
...
function EditAdmin() {
    ...
    return (
        <Nav>
            ...
            {/* First form tab */}
            <div className="w-[90%] md:w-[90%] space-y-8 bg-white p-10 rounded-lg shadow-md">
                {/* <p className='text-[#0A0909] font-bold text-[20px]' >Edit</p> */}
                <Formik
                    initialValues={{
                        name: '',
                        phoneNumber: '',
                        ...
                        <>
                            ...
                            <Form className='space-y-4'>
                                ...
                                <div>
                                    ...
                                    <input disabled name="password" type="password" value={"******"} className="mt-1 w-full px-3 py-2 text-black border cursor-not-allowed rounded-md shadow-sm border-[#5E6366] focus:outline-none focus:ring-none focus:ring-[#5E6366]" />
                                </div>
